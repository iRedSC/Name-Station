...
execute if score @s NS-s1-switch matches 0 run data modify block ~ ~-1 ~ Items append value {Slot:0b,id:"minecraft:emerald",Count:1b,tag:{display:{Name:'[{"text":"Prepend","color":"yellow","bold":true,"italic":false,"underlined":true},{"text":" | ","color":"white","italic":false,"underlined":false,"bold":false},{"text":"Set","color":"gray","italic":false,"underlined":false,"bold":false},{"text":" | ","color":"white","italic":false,"underlined":false,"bold":false},{"text":"Append","color":"gray","italic":false,"underlined":false,"bold":false}]',Lore:['{"text":" "}','[{"text":"Adds a new line of ","color":"gray","italic":false},{"text":"Lore","color":"dark_purple","italic":false}]','[{"text":"as the ","color":"gray","italic":false},{"text":"Top Line","color":"gold"}]']},NS:{Function:"Select.Prepend"}}}
