...
execute if score @s NS-s2-switch matches 0 run data modify block ~ ~-1 ~ Items prepend value {Slot:1b,id:"minecraft:iron_ingot",Count:1b,tag:{display:{Name:'[{"text":"Name ","color":"gold","italic":false},{"text":"| ","color":"white"},{"text":"Lore","color":"gray","italic":false}]',Lore:['{"text":"Editing the item\'s Name","color":"gray","italic":false}']},NS:{Function:"Select.Name"}}}
execute if score @s NS-s2-switch matches 1 run data modify block ~ ~-1 ~ Items prepend value {Slot:1b,id:"minecraft:iron_ingot",Count:1b,tag:{display:{Name:'[{"text":"Name ","color":"gray","italic":false},{"text":"| ","color":"white"},{"text":"Lore","color":"light_purple","italic":false}]',Lore:['{"text":"Editing the item\'s Lore","color":"gray","italic":false}','{"text":"Each page on the book will make a new line.","color":"gray","italic":false}']},NS:{Function:"Select.Lore"}}}
