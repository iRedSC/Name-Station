...
execute as @a if score @s NS.usedItem matches 1.. run playsound minecraft:entity.item.pickup master @s ~ ~ ~ 1 1 1
...
execute if score @s NS-s2-switch matches 1 run data modify block ~ ~-1 ~ Items append value {Slot:1b,id:"minecraft:gold_ingot",Count:1b,tag:{display:{Name:'[{"text":"Name ","color":"gray","italic":false},{"text":"| ","color":"white"},{"text":"Lore","color":"light_purple","italic":false}]',Lore:['{"text":"Editing the item\'s Lore","color":"gray","italic":false}','{"text":"Each page on the book will make a new line.","color":"gray","italic":false}']},NS:{Function:"Select.Lore"}}}
